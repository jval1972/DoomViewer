...
type
  ...
  TDDBltFX = record
    ...
    case Integer of
      ...
      1: (
        lpDDSZBufferDest: Pointer {IDirectDrawSurface};
          // Surface to use as Z buffer for dest
        _union1b: DWORD;
        lpDDSZBufferSrc: Pointer {IDirectDrawSurface};
          // Surface to use as Z buffer for src
        _union1d: DWORD;
        _union1e: DWORD;
        _union1f: DWORD;
        _union1g: DWORD;
        lpDDSAlphaDest: Pointer {IDirectDrawSurface};
          // Surface to use as Alpha Channel
        _union1i: DWORD;
        lpDDSAlphaSrc: Pointer {IDirectDrawSurface};
          // Surface to use as Alpha Channel
  ...
  TDDCaps_DX6 = record
    ...
    dwRops: array[0..DD_ROP_SPACE - 1] of DWORD; // ROPS supported
    ddsOldCaps: TDDSCaps;
      // Was TDDSCaps ddsCaps. ddsCaps is of type DDSCAPS2 for DX6
    dwMinOverlayStretch: DWORD;
      // minimum overlay stretch factor multiplied by 1000, eg 1000 == 1.0, 1300 == 1.3
    dwMaxOverlayStretch: DWORD;
      // maximum overlay stretch factor multiplied by 1000, eg 1000 == 1.0, 1300 == 1.3
...
{$ENDIF}
  ...
  IDirectDraw = interface(IUnknown)
    ...
    function CreateClipper(dwFlags: DWORD; out lplpDDClipper:
      IDirectDrawClipper;
    ...
    function EnumSurfaces(dwFlags: DWORD; const lpDDSD: TDDSurfaceDesc;
      lpContext: Pointer; lpEnumCallback: TDDEnumSurfacesCallback): HResult;
        stdcall;
  ...
  IDirectDraw4 = interface(IUnknown)
    ...
    function CreateSurface(const lpDDSurfaceDesc: TDDSurfaceDesc2;
      out lplpDDSurface: IDirectDrawSurface4; pUnkOuter: IUnknown): HResult;
        stdcall;
    ...
    function EnumSurfaces(dwFlags: DWORD; const lpDDSD: TDDSurfaceDesc2;
      lpContext: Pointer; lpEnumCallback: TDDEnumSurfacesCallback2): HResult;
        stdcall;
    function FlipToGDISurface: HResult; stdcall;
    function GetCaps(var lpDDDriverCaps: TDDCaps; var lpDDHELCaps: TDDCaps):
      HResult; stdcall;
    function GetDisplayMode(var lpDDSurfaceDesc: TDDSurfaceDesc2): HResult;
      stdcall;
    function GetFourCCCodes(var lpNumCodes, lpCodes: DWORD): HResult; stdcall;
    function GetGDISurface(out lplpGDIDDSSurface: IDirectDrawSurface2): HResult;
      stdcall;
    function GetMonitorFrequency(var lpdwFrequency: DWORD): HResult; stdcall;
    function GetScanLine(var lpdwScanLine: DWORD): HResult; stdcall;
    function GetVerticalBlankStatus(var lpbIsInVB: BOOL): HResult; stdcall;
    ...
    function GetSurfaceFromDC(hdc: HDC; lpDDS: IDirectDrawSurface4): HResult;
      stdcall;
    function RestoreAllSurfaces: HResult; stdcall;
    function TestCooperativeLevel: HResult; stdcall;
    function GetDeviceIdentifier(var lpdddi: TDDDeviceIdentifier; dwFlags:
  ...
  IDirectDraw7 = interface(IUnknown)
    ...
    function CreatePalette(dwFlags: DWORD; lpColorTable: PPaletteEntry;
      out lplpDDPalette: IDirectDrawPalette; pUnkOuter: IUnknown): HResult;
        stdcall;
    function CreateSurface(const lpDDSurfaceDesc: TDDSurfaceDesc2;
      out lplpDDSurface: IDirectDrawSurface7; pUnkOuter: IUnknown): HResult;
        stdcall;
    ...
    function EnumDisplayModes(dwFlags: DWORD;
      ...
      lpEnumModesCallback: TDDEnumModesCallback2): HResult; stdcall;
    function EnumSurfaces(dwFlags: DWORD; const lpDDSD: TDDSurfaceDesc2;
      lpContext: Pointer; lpEnumCallback: TDDEnumSurfacesCallback7): HResult;
        stdcall;
    function FlipToGDISurface: HResult; stdcall;
    function GetCaps(var lpDDDriverCaps: TDDCaps; var lpDDHELCaps: TDDCaps):
      HResult; stdcall;
    function GetDisplayMode(var lpDDSurfaceDesc: TDDSurfaceDesc2): HResult;
      stdcall;
    function GetFourCCCodes(var lpNumCodes, lpCodes: DWORD): HResult; stdcall;
    function GetGDISurface(out lplpGDIDDSSurface: IDirectDrawSurface7): HResult;
      stdcall;
    function GetMonitorFrequency(var lpdwFrequency: DWORD): HResult; stdcall;
    function GetScanLine(var lpdwScanLine: DWORD): HResult; stdcall;
    function GetVerticalBlankStatus(var lpbIsInVB: BOOL): HResult; stdcall;
    ...
    function StartModeTest(var lpModesToTest: TSize; dwNumEntries: DWORD;
      dwFlags: DWORD): HResult; stdcall;
    function EvaluateMode(dwFlags: DWORD; var pSecondsUntilTimeout: DWORD):
      HResult; stdcall;
  end;
  ...
  IDirectDrawSurface = interface(IUnknown)
    ...
    function Blt(const lpDestRect: TRect; lpDDSrcSurface: IDirectDrawSurface;
      const lpSrcRect: TRect; dwFlags: DWORD; const lpDDBltFx: TDDBltFX):
        HResult; stdcall;
  ...
  IDirectDrawSurface2 = interface(IUnknown)
    ...
    function GetSurfaceDesc(var lpDDSurfaceDesc: TDDSurfaceDesc): HResult;
      stdcall;
    function Initialize(lpDD: IDirectDraw; const lpDDSurfaceDesc:
  ...
  IDirectDrawSurface3 = interface(IUnknown)
    ...
    function SetSurfaceDesc(const lpddsd: TDDSurfaceDesc; dwFlags: DWORD):
      HResult; stdcall;
  end;
  ...
  IDirectDrawSurface4 = interface(IUnknown)
    ...
    function GetPixelFormat(var lpDDPixelFormat: TDDPixelFormat): HResult;
      stdcall;
    function GetSurfaceDesc(var lpDDSurfaceDesc: TDDSurfaceDesc2): HResult;
      stdcall;
    function Initialize(lpDD: IDirectDraw; const lpDDSurfaceDesc:
      TDDSurfaceDesc2): HResult; stdcall;
    function IsLost: HResult; stdcall;
    ...
    function SetPalette(lpDDPalette: IDirectDrawPalette): HResult; stdcall;
    function Unlock(lpSurfaceData: Pointer): HResult; stdcall;
    function UpdateOverlay(const lpSrcRect: TRect; lpDDDestSurface:
      IDirectDrawSurface4;
      const lpDestRect: TRect; dwFlags: DWORD; const lpDDOverlayFx:
        TDDOverlayFX): HResult; stdcall;
    function UpdateOverlayDisplay(dwFlags: DWORD): HResult; stdcall;
    function UpdateOverlayZOrder(dwFlags: DWORD; lpDDSReference:
      IDirectDrawSurface4): HResult; stdcall;
    // IDirectDrawSurface2 methods
    function GetDDInterface(out lplpDD: IUnknown): HResult; stdcall;
    function PageLock(dwFlags: DWORD): HResult; stdcall;
    function PageUnlock(dwFlags: DWORD): HResult; stdcall;
    // IDirectDrawSurface3 methods
    function SetSurfaceDesc(const lpddsd: TDDSurfaceDesc2; dwFlags: DWORD):
      HResult; stdcall;
  ...
  IDirectDrawGammaControl = interface(IUnknown)
    ...
    function GetGammaRamp(dwFlags: DWORD; var lpRampData: TDDGammaRamp): HResult;
      stdcall;
...
function DirectDrawEnumerateA(lpCallback: TDDEnumCallbackA; lpContext: Pointer):
  HResult; stdcall;
function DirectDrawEnumerateW(lpCallback: TDDEnumCallbackW; lpContext: Pointer):
  HResult; stdcall;
function DirectDrawEnumerate(lpCallback: TDDEnumCallbackA; lpContext: Pointer):
  HResult; stdcall;

function DirectDrawEnumerateExA(lpCallback: TDDEnumCallbackExA; lpContext:
  Pointer; dwFlags: DWORD): HResult; stdcall;
function DirectDrawEnumerateExW(lpCallback: TDDEnumCallbackExW; lpContext:
  Pointer; dwFlags: DWORD): HResult; stdcall;
function DirectDrawEnumerateEx(lpCallback: TDDEnumCallbackExA; lpContext:
  Pointer; dwFlags: DWORD): HResult; stdcall;
...
function DirectDrawCreateEx(lpGUID: PGUID; out lplpDD; const iid: TGUID;
  pUnkOuter: IUnknown): HResult; stdcall;
function DirectDrawCreateClipper(dwFlags: DWORD; out lplpDDClipper:
  IDirectDrawClipper;
  pUnkOuter: IUnknown): HResult; stdcall;
...
type
  ...
  IDirectDrawVideoPort = interface(IUnknown)
    ...
    function Flip(lpDDSurface: IDirectDrawSurface; dwFlags: DWORD): HResult;
      stdcall;
    function GetBandwidthInfo(const lpddpfFormat: TDDPixelFormat; dwWidth:
      DWORD;
      dwHeight: DWORD; dwFlags: DWORD; var lpBandwidth: TDDVideoportBandWidth):
        HResult; stdcall;
    function GetColorControls(var lpColorControl: TDDColorControl): HResult;
      stdcall;
...
type
  TD3DValidateCallback = function(lpUserArg: Pointer; dwOffset: DWORD): HResult;
    stdcall;
...
type
  ...
  TD3DEnumDevicesCallback7 = function(lpDeviceDescription: LPSTR; lpDeviceName:
    LPSTR;
    const lpD3DDeviceDesc: TD3DDeviceDesc7; lpUserArg: Pointer): HResult;
      stdcall;
...
type
  ...
  IDirect3D3 = interface(IUnknown)
    ...
    function CreateDevice(const rclsid: TGUID; lpDDS: IDirectDrawSurface4;
      out lplpD3DDevice2: IDirect3DDevice3; pUnkOuter: IUnknown): HResult;
        stdcall;
    // IDirect3D3 methods
    function CreateVertexBuffer(const lpVBDesc: TD3DVertexBufferDesc;
      out lpD3DVertexBuffer: IDirect3DVertexBuffer; dwFlags: DWORD; pUnkOuter:
  ...
  IDirect3D7 = interface(IUnknown)
    ...
    function CreateVertexBuffer(const lpVBDesc: TD3DVertexBufferDesc;
      out lpD3DVertexBuffer: IDirect3DVertexBuffer7; dwFlags: DWORD): HResult;
        stdcall;
    function EnumZBufferFormats(const riidDevice: TGUID; lpEnumCallback:
      TD3DEnumPixelFormatsCallback;
      lpContext: Pointer): HResult; stdcall;
  ...
  IDirect3DDevice2 = interface(IUnknown)
    ...
    function GetStats(var lpD3DStats: TD3DStats): HResult; stdcall;
    function AddViewport(lpDirect3DViewport: IDirect3DViewport2): HResult;
      stdcall;
  ...
  IDirect3DDevice3 = interface(IUnknown)
    ...
    function GetCaps(var lpD3DHWDevDesc: TD3DDeviceDesc;
      var lpD3DHELDevDesc: TD3DDeviceDesc): HResult; stdcall;
    function GetStats(var lpD3DStats: TD3DStats): HResult; stdcall;
    function AddViewport(lpDirect3DViewport: IDirect3DViewport3): HResult;
      stdcall;
    function DeleteViewport(lpDirect3DViewport: IDirect3DViewport3): HResult;
      stdcall;
    function NextViewport(lpDirect3DViewport: IDirect3DViewport3;
      out lplpDirect3DViewport: IDirect3DViewport3; dwFlags: DWORD): HResult;
        stdcall;
    ...
    function SetCurrentViewport(lpd3dViewport: IDirect3DViewport3): HResult;
      stdcall;
    function GetCurrentViewport(out lplpd3dViewport: IDirect3DViewport3):
      HResult; stdcall;
    function SetRenderTarget(lpNewRenderTarget: IDirectDrawSurface4): HResult;
      stdcall;
    function GetRenderTarget(out lplpNewRenderTarget: IDirectDrawSurface4):
      HResult; stdcall;
    function Begin_(d3dpt: TD3DPrimitiveType; dwVertexTypeDesc: DWORD;
      dwFlags: DWORD): HResult; stdcall;
    function BeginIndexed(dptPrimitiveType: TD3DPrimitiveType; dwVertexTypeDesc:
      DWORD;
      const lpvVertices; dwNumVertices: DWORD; dwFlags: DWORD): HResult;
        stdcall;
    function Vertex(const lpVertexType): HResult; stdcall;
    function Index(wVertexIndex: WORD): HResult; stdcall;
    function End_(dwFlags: DWORD): HResult; stdcall;
    ...
    function DrawIndexedPrimitiveStrided(dptPrimitiveType: TD3DPrimitiveType;
      dwVertexTypeDesc: DWORD; const lpVertexArray;
      dwVertexCount: DWORD; const lpwIndices; dwIndexCount: DWORD; dwFlags:
        DWORD): HResult; stdcall;
    ...
    function DrawIndexedPrimitiveVB(dptPrimitiveType: TD3DPrimitiveType;
      lpd3dVertexBuffer: IDirect3DVertexBuffer; const lpwIndices; dwIndexCount:
        DWORD;
      dwFlags: DWORD): HResult; stdcall;
    function ComputeSphereVisibility(const lpCenters; const lpRadii;
      dwNumSpheres: DWORD; dwFlags: DWORD; var lpdwReturnValues): HResult;
        stdcall;
    function GetTexture(dwStage: DWORD; out lplpTexture: IDirect3DTexture2):
      HResult; stdcall;
    function SetTexture(dwStage: DWORD; lpTexture: IDirect3DTexture2): HResult;
      stdcall;
    function GetTextureStageState(dwStage: DWORD; dwState:
      TD3DTextureStagesStateType;
      var lpdwValue: DWORD): HResult; stdcall;
    function SetTextureStageState(dwStage: DWORD; dwState:
      TD3DTextureStagesStateType;
  ...
  IDirect3DDevice7 = interface(IUnknown)
    ...
    function SetRenderTarget(lpNewRenderTarget: IDirectDrawSurface7; dwFlags:
      DWORD): HResult; stdcall;
    function GetRenderTarget(out lplpRenderTarget: IDirectDrawSurface7): HResult;
      stdcall;
    function Clear(dwCount: DWORD; const lpRects: TD3DRect; dwFlags: DWORD;
      dwColor: TD3DColor;
      dvZ: TD3DValue; dwStencil: DWORD): HResult; stdcall;
    function SetTransform(dtstTransformStateType: TD3DTransformStateType; const
      lpD3DMatrix: TD3DMatrix): HResult; stdcall;
    function GetTransform(dtstTransformStateType: TD3DTransformStateType; var
      lpD3DMatrix: TD3DMatrix): HResult; stdcall;
    ...
    function SetLight(dwLightIndex: DWORD; const lpLight: TD3DLight7): HResult;
      stdcall;
    function GetLight(dwLightIndex: DWORD; var lpLight: TD3DLight7): HResult;
      stdcall;
    function SetRenderState(dwRenderStateType: TD3DRenderStateType;
      dwRenderState: DWORD): HResult; stdcall;
    function GetRenderState(dwRenderStateType: TD3DRenderStateType; var
      lpdwRenderState: DWORD): HResult; stdcall;
    ...
    function DrawPrimitive(dptPrimitiveType: TD3DPrimitiveType;
      ...
      const lpvVertices; dwVertexCount: DWORD; dwFlags: DWORD): HResult;
        stdcall;
    function DrawIndexedPrimitive(d3dptPrimitiveType: TD3DPrimitiveType;
      dwVertexTypeDesc: DWORD;
      const lpvVertices; dwVertexCount: DWORD; const lpwIndices; dwIndexCount:
        DWORD; dwFlags: DWORD): HResult; stdcall;
    function SetClipStatus(const lpD3DClipStatus: TD3DClipStatus): HResult;
      stdcall;
    function GetClipStatus(var lpD3DClipStatus: TD3DClipStatus): HResult;
      stdcall;
    function DrawPrimitiveStrided(dptPrimitiveType: TD3DPrimitiveType;
      dwVertexTypeDesc: DWORD;
      const lpVertexArray; dwVertexCount: DWORD; dwFlags: DWORD): HResult;
        stdcall;
    function DrawIndexedPrimitiveStrided(d3dptPrimitiveType: TD3DPrimitiveType;
      dwVertexTypeDesc: DWORD;
      const lpVertexArray; dwVertexCount: DWORD; const lpwIndices; dwIndexCount:
        DWORD; dwFlags: DWORD): HResult; stdcall;
    function DrawPrimitiveVB(d3dptPrimitiveType: TD3DPrimitiveType;
      lpd3dVertexBuffer: IDirect3DVertexBuffer7;
      dwStartVertex: DWORD; dwNumVertices: DWORD; dwFlags: DWORD): HResult;
        stdcall;
    function DrawIndexedPrimitiveVB(d3dptPrimitiveType: TD3DPrimitiveType;
      lpd3dVertexBuffer: IDirect3DVertexBuffer7;
      dwStartVertex: DWORD; dwNumVertices: DWORD; const lpwIndices;
        dwIndexCount: DWORD; dwFlags: DWORD): HResult; stdcall;
    function ComputeSphereVisibility(const lpCenters; const lpRadii;
      dwNumSpheres: DWORD; dwFlags: DWORD; var lpdwReturnValue): HResult; stdcall;
    function GetTexture(dwStage: DWORD; out lplpTexture: IDirectDrawSurface7):
      HResult; stdcall;
    function SetTexture(dwStage: DWORD; lpTexture: IDirectDrawSurface7): HResult;
      stdcall;
    function GetTextureStageState(dwStage: DWORD; dwState:
      TD3DTextureStagesStateType; var lpdwValue: DWORD): HResult; stdcall;
    function SetTextureStageState(dwStage: DWORD; dwState:
      TD3DTextureStagesStateType; dwValue: DWORD): HResult; stdcall;
    function ValidateDevice(var lpdwPasses: DWORD): HResult; stdcall;
    ...
    function CreateStateBlock(d3dsbType: TD3DSTATEBLOCKTYPE; var
      lpdwBlockHandle: DWORD): HResult; stdcall;
    function Load(lpDestTex: IDirectDrawSurface7; const lpDestPoint: TPoint;
      lpSrcTex: IDirectDrawSurface7; const lprcSrcRect: TRect; dwFlags: DWORD):
      HResult; stdcall;
    function LightEnable(dwLightIndex: DWORD; bEnable: BOOL): HResult; stdcall;
    function GetLightEnable(dwLightIndex: DWORD; var pbEnable: BOOL): HResult;
      stdcall;
    function SetClipPlane(dwIndex: DWORD; const pPlaneEquation): HResult;
      stdcall;
    function GetClipPlane(dwIndex: DWORD; var pPlaneEquation): HResult; stdcall;
    function GetInfo(dwDevInfoID: DWORD; pDevInfoStruct: Pointer; dwSize:
      DWORD): HResult; stdcall;
  end;
  ...
  IDirect3DViewport3 = interface(IDirect3DViewport2)
    ...
    function GetBackgroundDepth2(out lplpDDS: IDirectDrawSurface4; var lpValid:
  ...
  IDirect3DVertexBuffer = interface(IUnknown)
    ...
    function Lock(dwFlags: DWORD; var lplpData: Pointer; var lpdwSize: DWORD):
      HResult; stdcall;
    function Unlock: HResult; stdcall;
    function ProcessVertices(dwVertexOp: DWORD; dwDestIndex: DWORD; dwCount:
      DWORD;
      lpSrcBuffer: IDirect3DVertexBuffer; dwSrcIndex: DWORD;
      lpD3DDevice: IDirect3DDevice3; dwFlags: DWORD): HResult; stdcall;
    function GetVertexBufferDesc(var lpVBDesc: TD3DVertexBufferDesc): HResult;
      stdcall;
    function Optimize(lpD3DDevice: IDirect3DDevice3; dwFlags: DWORD): HResult;
      stdcall;
  end;
  ...
  IDirect3DVertexBuffer7 = interface(IUnknown)
    ...
    function ProcessVertices(dwVertexOp: DWORD; dwDestIndex: DWORD; dwCount:
      DWORD;
      lpSrcBuffer: IDirect3DVertexBuffer7; dwSrcIndex: DWORD; lpD3DDevice:
        IDirect3DDevice7; dwFlags: DWORD): HResult; stdcall;
    function GetVertexBufferDesc(var lpVBDesc: TD3DVertexBufferDesc): HResult;
      stdcall;
    function Optimize(lpD3DDevice: IDirect3DDevice7; dwFlags: DWORD): HResult;
      stdcall;
    function ProcessVerticesStrided(dwVertexOp: DWORD; dwDestIndex: DWORD;
      dwCount: DWORD;
      const lpVertexArray; dwSrcIndex: DWORD; lpD3DDevice: IDirect3DDevice7;
        dwFlags: DWORD): HResult; stdcall;
  end;
...
const
  D3DRMRENDER_WIREFRAME = D3DRMSHADE_FLAT + D3DRMLIGHT_OFF +
    D3DRMFILL_WIREFRAME;
...
const
  D3DRMSHADOW_TRUEALPHA = $00000001;
    // shadow should render without artifacts when true alpha is on
...
procedure D3DRMAnimationGetRotateKey(const rmKey: TD3DRMAnimationKey; var
  rmQuat: TD3DRMQuaternion);
procedure D3DRMAnimationGetScaleKey(const rmKey: TD3DRMAnimationKey; var dvVec:
  TD3DVector);
procedure D3DRMAnimationGetPositionKey(const rmKey: TD3DRMAnimationKey; var
  dvVec: TD3DVector);
procedure D3DRMAnimationSetRotateKey(var rmKey: TD3DRMAnimationKey; const
  rmQuat: TD3DRMQuaternion);
procedure D3DRMAnimationSetScaleKey(var rmKey: TD3DRMAnimationKey; const dvVec:
  TD3DVector);
procedure D3DRMAnimationSetPositionKey(var rmKey: TD3DRMAnimationKey; const
  dvVec: TD3DVector);
...
function D3DRMCreateColorRGBA(red, green, blue, alpha: TD3DValue): TD3DColor;
  stdcall;
...
function D3DRMVectorScale(var d, s: TD3DVector; factor: TD3DValue): PD3DVector;
  stdcall;
...
function D3DRMQuaternionFromMatrix(var lpQuat: TD3DRMQuaternion; Mat:
  TD3DRMMatrix4D): PD3DRMQuaternion;
...
const
  ...
  CLSID_CDirect3DRMMeshBuilder: TGUID =
    '{4FA35692-623F-11CF-AC4A-0000C03825A1}';
  ...
  CLSID_CDirect3DRMAnimationSet: TGUID =
    '{4FA35699-623F-11CF-AC4A-0000C03825A1}';
  ...
  CLSID_CDirect3DRMViewportInterpolator: TGUID =
    '{0DE9EAA1-3B84-11D0-9B6D-0000C0781BC3}';
  CLSID_CDirect3DRMFrameInterpolator: TGUID =
    '{0DE9EAA2-3B84-11D0-9B6D-0000C0781BC3}';
  CLSID_CDirect3DRMMeshInterpolator: TGUID =
    '{0DE9EAA3-3B84-11D0-9B6D-0000C0781BC3}';
  CLSID_CDirect3DRMLightInterpolator: TGUID =
    '{0DE9EAA6-3B84-11D0-9B6D-0000C0781BC3}';
  CLSID_CDirect3DRMMaterialInterpolator: TGUID =
    '{0DE9EAA7-3B84-11D0-9B6D-0000C0781BC3}';
  CLSID_CDirect3DRMTextureInterpolator: TGUID =
    '{0DE9EAA8-3B84-11D0-9B6D-0000C0781BC3}';
  CLSID_CDirect3DRMProgressiveMesh: TGUID =
    '{4516EC40-8F20-11D0-9B6D-0000C0781BC3}';
  CLSID_CDirect3DRMClippedVisual: TGUID =
    '{5434E72D-6D66-11D1-BB0B-0000F875865A}';
...
type
  ...
  TD3DRMFrameMoveCallback = procedure(obj: IDirect3DRMFrame; arg: Pointer;
    delta: TD3DValue); cdecl;
  D3DRMFRAMEMOVECALLBACK = TD3DRMFrameMoveCallback;

  TD3DRMFrame3MoveCallback = procedure(obj: IDirect3DRMFrame3; arg: Pointer;
    delta: TD3DValue); cdecl;
  ...
  TD3DRMLoadCallback = procedure(lpObject: IDirect3DRMObject; const ObjectGuid:
    TGUID;
    lpArg: Pointer); cdecl;
  ...
  TD3DRMValidationCallback = function(lpDirect3DRMTexture: IDirect3DRMTexture3;
    pArg: Pointer; dwFlags: DWORD; dwcRects: DWORD; pRects: PRect): HResult;
      cdecl;
  ...
  IDirect3DRMObject2 = interface(IUnknown)
    ...
    function AddDestroyCallback(lpCallback: TD3DRMObjectCallback; lpArg:
    ...
    function SetClientData(dwID: DWORD; lplpvData: Pointer; dwFlags: DWORD):
      HResult; stdcall;
    function SetName(lpName: PChar): HResult; stdcall;
  ...
  IDirect3DRMDevice = interface(IDirect3DRMObject)
    ...
    function SetTextureQuality(tqTextureQuality: TD3DRMTextureQuality): HResult;
      stdcall;
  ...
  IDirect3DRMViewport = interface(IDirect3DRMObject)
    ...
    function Transform(var lprvDst: TD3DRMVector4D; const lprvSrc: TD3DVector):
      HResult; stdcall;
  ...
  IDirect3DRMFrame = interface(IDirect3DRMVisual)
    ...
    function SetSceneBackgroundRGB(rvRed, rvGreen, rvBlue: TD3DValue): HResult;
      stdcall;
  ...
  IDirect3DRMFrame2 = interface(IDirect3DRMFrame)
    ...
    function SetQuaternion(lpRef: IDirect3DRMFrame2; var quat:
      TD3DRMQuaternion): HResult; stdcall;
    function RayPick(lpRefFrame: IDirect3DRMFrame; const ray: TD3DRMRay;
      dwFlags: DWORD; out lplpPicked2Array: IDirect3DRMPicked2Array): HResult;
        stdcall;
  ...
  IDirect3DRMFrame3 = interface(IDirect3DRMVisual)
    ...
    function GetTransform(RefFrame: IDirect3DRMFrame3; var rmMatrix:
      TD3DRMMatrix4D): HResult; stdcall;
    ...
    function GetOrientation(lpRef: IDirect3DRMFrame3; var lprvDir: TD3DVector;
      var lprvUp: TD3DVector): HResult; stdcall;
    function GetVisuals(var pdwNumVisuals: DWORD; var lplpVisuals: Pointer):
      HResult; stdcall;
    function InverseTransform(var lprvDst, lprvSrc: TD3DVector): HResult;
      stdcall;
    function Load(lpvObjSource: Pointer; lpvObjID: Pointer;
    ...
    function DeleteLight(lpD3DRMLight: IDirect3DRMLight): HResult; stdcall;
    function DeleteMoveCallback(d3drmFMC: TD3DRMFrame3MoveCallback; lpArg:
      Pointer): HResult; stdcall;
    function DeleteVisual(lpD3DRMVisual: IDirect3DRMVisual): HResult; stdcall;
    function GetSceneBackground: TD3DColor; stdcall;
    function GetSceneBackgroundDepth(out lplpDDSurface: IDirectDrawSurface):
    ...
    function SetPosition(lpRef: IDirect3DRMFrame3; rvX, rvY, rvZ: TD3DValue):
      HResult; stdcall;
    function SetRotation(lpRef: IDirect3DRMFrame3; rvX, rvY, rvZ, rvTheta:
    ...
    function GetBoxEnable: BOOL; stdcall;
    function GetAxes(var dir, up: TD3DVector): HResult; stdcall;
    function GetMaterial(out lplpMaterial: IDirect3DRMMaterial2): HResult;
      stdcall;
    function GetInheritAxes: BOOL; stdcall;
    function GetHierarchyBox(var lpD3DRMBox: TD3DRMBox): HResult; stdcall;
    function SetBox(const lpD3DRMBox: TD3DRMBox): HResult; stdcall;
    ...
    function SetQuaternion(lpRef: IDirect3DRMFrame3; var quat:
      TD3DRMQuaternion): HResult; stdcall;
    ...
    function TransformVectors(reference: IDirect3DRMFrame3; dwNumVectors: DWORD;
      var lpDstVectors: TD3DVector; const lpSrcVectors: TD3DVector): HResult;
        stdcall;
    function InverseTransformVectors(reference: IDirect3DRMFrame3; dwNumVectors:
      DWORD;
      var lpDstVectors: TD3DVector; const lpSrcVectors: TD3DVector): HResult;
        stdcall;
    ...
    function SetMaterialOverride(lpdmOverride: TD3DRMMaterialOverride): HResult;
      stdcall;
    function GetMaterialOverride(var lplpdmOverride: TD3DRMMaterialOverride):
      HResult; stdcall;
  end;
  ...
  IDirect3DRMShadow2 = interface(IDirect3DRMShadow)
    ...
    function GetVisual(out lplpDirect3DRMVisual: IDirect3DRMVisual): HResult;
      stdcall;
    function SetVisual(pUNK: IUnknown; dwFlags: DWORD): HResult; stdcall;
    function GetLight(out lplpDirect3DRMLight: IDirect3DRMLight): HResult;
      stdcall;
    function SetLight(lpDirect3DRMLight: IDirect3DRMLight; dwFlags: DWORD):
      HResult; stdcall;
    function GetPlane(var px, py, pz: TD3DValue; var nx, ny, nz: TD3DValue):
      HResult; stdcall;
    function SetPlane(px, py, pz: TD3DValue; nx, ny, nz: TD3DValue): HResult;
      stdcall;
  ...
  IDirect3DRMFace = interface(IDirect3DRMObject)
    ...
    function SetTextureTopology(cylU, cylV: BOOL): HResult; stdcall;
    function GetVertex(index: DWORD; var lpPosition: TD3DVector; var lpNormal:
      TD3DVector): HResult; stdcall;
    function GetVertices(var lpdwVertexCount: DWORD; var lpPosition, lpNormal:
      TD3DVector): HResult; stdcall;
  ...
  IDirect3DRMMeshBuilder = interface(IDirect3DRMVisual)
    ...
    function Load(lpvObjSource, lpvObjID: Pointer; d3drmLOFlags:
      TD3DRMLoadOptions;
      d3drmLoadTextureProc: TD3DRMLoadTextureCallback; lpvArg: Pointer): HResult;
        stdcall;
    ...
    function GetTextureCoordinates(index: DWORD; var u, v: TD3DValue): HResult;
      stdcall;
  ...
  IDirect3DRMMeshBuilder2 = interface(IDirect3DRMMeshBuilder)
    ...
    function GenerateNormals2(dvCreaseAngle: TD3DValue; dwFlags: DWORD): HResult;
      stdcall;
  ...
  IDirect3DRMMeshBuilder3 = interface(IDirect3DRMVisual)
    ...
    function Load(lpvObjSource, lpvObjID: Pointer; d3drmLOFlags:
      TD3DRMLoadOptions;
      d3drmLoadTextureProc: TD3DRMLoadTexture3Callback; lpvArg: Pointer):
        HResult; stdcall;
    function Save(lpFilename: PChar; TD3DRMXOFFormat: TD3DRMXOFFormat;
      d3drmSOContents: TD3DRMSaveOptions): HResult; stdcall;
    function Scale(sx, sy, sz: TD3DValue): HResult; stdcall;
    ...
    function GetColorSource: TD3DRMColorSource; stdcall;
    function AddMesh(lpD3DRMMesh: IDirect3DRMMesh): HResult; stdcall;
    function AddMeshBuilder(lpD3DRMMeshBuild: IDirect3DRMMeshBuilder3): HResult;
      stdcall;
    ...
    function SetColor(color: TD3DColor): HResult; stdcall;
    function SetTexture(lpD3DRMTexture: IDirect3DRMTexture3): HResult; stdcall;
    function SetMaterial(lpDirect3DRMMaterial: IDirect3DRMMaterial2): HResult;
      stdcall;
    function SetTextureTopology(cylU, cylV: BOOL): HResult; stdcall;
    function SetQuality(quality: TD3DRMRenderQuality): HResult; stdcall;
    function SetPerspective(perspective: BOOL): HResult; stdcall;
    ...
    function GetFaces(out lplpD3DRMFaceArray: IDirect3DRMFaceArray): HResult;
      stdcall;
    function GetGeometry(var vcount: DWORD; var vertices; var ncount: DWORD; var
      normals;
    ...
    function GetVertexColor(index: DWORD): TD3DColor; stdcall;
    function CreateMesh(out lplpD3DRMMesh: IDirect3DRMMesh): HResult; stdcall;
    function GetFace(dwIndex: DWORD; out lplpD3DRMFace: IDirect3DRMFace2):
      HResult; stdcall;
    ...
    function GetNormal(dwIndex: DWORD; var lpVector: TD3DVector): HResult;
      stdcall;
    function DeleteVertices(dwIndexFirst: DWORD; dwCount: DWORD): HResult;
      stdcall;
    function DeleteNormals(dwIndexFirst: DWORD; dwCount: DWORD): HResult;
      stdcall;
    ...
    function GetParentMesh(dwFlags: DWORD; out lplpUnk: IUnknown): HResult;
      stdcall;
    function GetSubMeshes(var lpdwCount: DWORD; out lplpUnk: IUnknown): HResult;
      stdcall;
  ...
  IDirect3DRMTexture3 = interface(IDirect3DRMTexture2)
    ...
    function GetSurface(dwFlags: DWORD; out lplpDDS: IDirectDrawSurface):
      HResult; stdcall;
    function SetCacheOptions(lImportance: Longint; dwFlags: DWORD): HResult;
      stdcall;
    function GetCacheOptions(var lplImportance: Longint; var lpdwFlags: DWORD):
      HResult; stdcall;
    function SetDownsampleCallback(pCallback: TD3DRMDownSampleCallback; pArg:
      Pointer): HResult; stdcall;
    function SetValidationCallback(pCallback: TD3DRMValidationCallback; pArg:
      Pointer): HResult; stdcall;
  end;
  ...
  IDirect3DRMAnimation = interface(IDirect3DRMObject)
    ...
    function SetOptions(d3drmanimFlags: TD3DRMAnimationOptions): HResult;
      stdcall;
    function AddRotateKey(rvTime: TD3DValue; const rqQuat: TD3DRMQuaternion):
      HResult; stdcall;
  ...
  IDirect3DRMAnimationSet2 = interface(IDirect3DRMObject)
    ...
    function GetAnimations(out lpAnimationArray: IDirect3DRMAnimationArray):
      HResult; stdcall;
  end;
  ...
  IDirect3DRMObjectarray = interface(IDirect3DRMArray)
    function GetElement(index: DWORD; out lplpD3DRMObject: IDirect3DRMObject):
      HResult; stdcall;
  end;
  ...
  IDirect3DRMDeviceArray = interface(IDirect3DRMArray)
    ...
    function GetElement(index: DWORD; out lplpD3DRMDevice: IDirect3DRMDevice):
      HResult; stdcall;
  end;
  ...
  IDirect3DRMVisualArray = interface(IDirect3DRMArray)
    ...
    function GetElement(index: DWORD; out lplpD3DRMVisual: IDirect3DRMVisual):
      HResult; stdcall;
  end;

  IDirect3DRMAnimationArray = interface(IDirect3DRMArray)
    ['{D5F1CAE0-4BD7-11D1-B974-0060083E45F3}']
    function GetElement(index: DWORD; out lplpD3DRMAnimation:
  ...
  IDirect3DRMClippedVisual = interface(IDirect3DRMVisual)
    ...
    function AddPlane(lpRef: IDirect3DRMFrame3; const lpdvPoint, lpdvNormal:
      TD3DVector;
    ...
    function SetPlane(dwID: DWORD; lpRef: IDirect3DRMFrame3;
      const lpdvPoint, lpdvNormal: TD3DVector; dwFlags: DWORD): HResult;
        stdcall;
  end;
  ...
  IDirect3DRM = interface(IUnknown)
    ...
    function CreateLight(d3drmltLightType: TD3DRMLightType;
      cColor: TD3DColor; out lplpD3DRMLight: IDirect3DRMLight): HResult;
        stdcall;
  ...
  IDirect3DRM2 = interface(IUnknown)
    ...
    function CreateLightRGB(ltLightType: TD3DRMLightType; vRed,
      vGreen, vBlue: TD3DValue; out lplpD3DRMLight: IDirect3DRMLight): HResult;
        stdcall;
    function CreateMaterial(vPower: TD3DValue; out lplpD3DRMMaterial:
      IDirect3DRMMaterial): HResult; stdcall;
    function CreateDevice(dwWidth, dwHeight: DWORD; out lplpD3DRMDevice:
    ...
    function LoadTextureFromResource(hModule: HModule; str: LPCSTR; out
      lplpD3DRMTexture:
      IDirect3DRMTexture2): HResult; stdcall;
    function SetSearchPath(lpPath: LPSTR): HResult; stdcall;
    function AddSearchPath(lpPath: LPSTR): HResult; stdcall;
  ...
  IDirect3DRM3 = interface(IUnknown)
    ...
    function CreateFace(out lplpd3drmFace: IDirect3DRMFace2): HResult; stdcall;
    function CreateAnimation(out lplpD3DRMAnimation: IDirect3DRMAnimation2):
      HResult; stdcall;
    function CreateAnimationSet(out lplpD3DRMAnimationSet:
    ...
    function CreateDeviceFromSurface(const lpGUID: TGUID; lpDD: IDirectDraw;
      lpDDSBack: IDirectDrawSurface; out lplpD3DRMDevice: IDirect3DRMDevice3):
        HResult; stdcall;
    function CreateDeviceFromD3D(lpD3D: IDirect3D2; lpD3DDev: IDirect3DDevice2;
...
type
  ...
  IDirectXFile = interface(IUnknown)
    ...
    function CreateEnumObject(pvSource: Pointer; dwLoadOptions:
      TDXFileLoadOptions;
    ...
    function RegisterTemplates(pvData: Pointer; cbSize: DWORD): HResult;
      stdcall;
  end;

  IDirectXFileEnumObject = interface(IUnknown)
    ['{3D82AB41-62DA-11CF-AB39-0020AF71E433}']
    function GetNextDataObject(out ppDataObj: IDirectXFileData): HResult;
      stdcall;
    function GetDataObjectById(const rguid: TGUID; out ppDataObj:
      IDirectXFileData): HResult; stdcall;
    function GetDataObjectByName(szName: PChar; out ppDataObj:
      IDirectXFileData): HResult; stdcall;
  end;
  ...
  IDirectXFileData = interface(IDirectXFileObject)
    ...
    function GetNextObject(out ppChildObj: IDirectXFileObject): HResult;
      stdcall;
  ...
  IDirectXFileBinary = interface(IDirectXFileObject)
    ...
    function Read(pvData: Pointer; cbSize: DWORD; var pcbRead: DWORD): HResult;
      stdcall;
  end;
...
{$ENDIF}
  ...
  TDIEnumEffectsInFileCallback = function(const lpDiFileEf: TDIFileEffect;
    pvRef: Pointer): BOOL; far pascal;
...
type
  ...
  IDirectInputEffect = interface(IUnknown)
    ...
    function GetParameters(var peff: TDIEffect; dwFlags: DWORD): HResult;
      stdcall;
...
{$ENDIF}
  ...
  IDirectInputDeviceW = interface(IUnknown)
    ...
    function GetProperty(rguidProp: PGUID; var pdiph: TDIPropHeader): HResult;
      stdcall;
    function SetProperty(rguidProp: PGUID; const pdiph: TDIPropHeader): HResult;
      stdcall;
...
type
  ...
  IDirectInputDevice2W = interface(IDirectInputDeviceW)
    ...
    function GetEffectInfo(var pdei: TDIEffectInfoW; const rguid: TGUID):
      HResult; stdcall;
    ...
    function SendDeviceData(cbObjectData: DWORD; const rgdod:
      TDIDeviceObjectData;
  ...
  IDirectInputDevice2A = interface(IDirectInputDeviceA)
    ...
    function EnumEffects(lpCallback: TDIEnumEffectsCallbackA; pvRef: Pointer;
      dwEffType: DWORD): HResult; stdcall;
    function GetEffectInfo(var pdei: TDIEffectInfoA; const rguid: TGUID):
      HResult; stdcall;
    function GetForceFeedbackState(var pdwOut: DWORD): HResult; stdcall;
    function SendForceFeedbackCommand(dwFlags: DWORD): HResult; stdcall;
    function EnumCreatedEffectObjects(lpCallback:
  ...
  IDirectInputDevice7W = interface(IDirectInputDevice2W)
    ...
    function EnumEffectsInFile(lpszFileName: LPCWSTR; pec:
      TDIEnumEffectsInFileCallback;
      pvRef: Pointer; dwFlags: DWORD): HResult; stdcall;
  ...
  IDirectInputDevice7A = interface(IDirectInputDevice2A)
    ...
    function EnumEffectsInFile(lpszFileName: LPCSTR; pec:
      TDIEnumEffectsInFileCallback;
      pvRef: Pointer; dwFlags: DWORD): HResult; stdcall;
...
const
  _c_dfDIMouse_Objects: array[0..1] of TDIObjectDataFormat = (
    (pguid: nil; dwOfs: 0; dwType: DIDFT_RELAXIS or DIDFT_ANYINSTANCE; dwFlags:
      0),
    (pguid: @GUID_Button; dwOfs: 12; dwType: DIDFT_BUTTON or DIDFT_ANYINSTANCE;
      dwFlags: 0)
    );
...
const
  _c_dfDIKeyboard_Objects: array[0..0] of TDIObjectDataFormat = (
    (pguid: @GUID_Key; dwOfs: 1; dwType: DIDFT_BUTTON or DIDFT_ANYINSTANCE;
      dwFlags: 0)
    );
...
function DirectInputCreateEx(hinst: THandle; dwVersion: DWORD;
  const riidltf: TGUID; out ppDI: IDirectInputA; punkOuter: IUnknown): HResult;
    stdcall;
...
type
  ...
  TDPEnumDPCallback = function(const lpguidSP: TGUID; lpSPName: LPWSTR;
    dwMajorVersion: DWORD; dwMinorVersion: DWORD; lpContext: Pointer): BOOL;
      stdcall;
...
type
  IDirectPlay2 = interface(IUnknown)
    ...
    function GetPlayerData(idPlayer: TDPID; var lpData; var lpdwDataSize: DWORD;
      dwFlags: DWORD): HResult; stdcall;
    function GetPlayerName(idPlayer: TDPID; var lpData; var lpdwDataSize:
      DWORD): HResult; stdcall;
  ...
  IDirectPlay3 = interface(IDirectPlay2)
    ...
    function CreateGroupInGroup(idParentGroup: TDPID; var lpidGroup: TDPID;
      ...
      dwFlags: DWORD): HResult; stdcall;
    function DeleteGroupFromGroup(idParentGroup: TDPID; idGroup: TDPID): HResult;
      stdcall;
  ...
  IDirectPlay4 = interface(IDirectPlay3)
    ...
    function GetGroupOwner(idGroup: TDPID; var idOwner: TDPID): HResult;
      stdcall;
    ...
    function CancelMessage(dwMessageID: DWORD; dwFlags: DWORD): HResult;
      stdcall;
    function CancelPriority(dwMinPriority: DWORD; dwMaxPriority: DWORD; dwFlags:
      DWORD): HResult; stdcall;
  end;
...
type
  IDirectPlay = interface(IUnknown)
    ...
    function GetMessageCount(pidID: TDPID; var lpdwCount: DWORD): HResult;
      stdcall;
    function GetPlayerCaps(pidID: TDPID; const lpDPPlayerCaps: TDPCaps): HResult;
      stdcall;
...
type
  IDirectPlayLobby = interface(IUnknown)
    ...
    function ReceiveLobbyMessage(dwFlags: DWORD; dwAppID: DWORD;
      var lpdwMessageFlags: DWORD; var lpData; var lpdwDataSize: DWORD): HResult;
        stdcall;
  ...
  IDirectPlayLobby2 = interface(IDirectPlayLobby)
    ...
    function CreateCompoundAddress(const lpElements: TDPCompoundAddressElement;
      dwElementCount: DWORD; var lpAddress; var lpdwAddressSize: DWORD): HResult;
        stdcall;
  end;
  ...
  IDirectPlayLobby3 = interface(IDirectPlayLobby2)
    ...
    function ConnectEx(dwFlags: DWORD; const riid: TGUID; var lplpDP: Pointer;
      pUnk: IUnknown): HResult; stdcall;
    function RegisterApplication(dwFlags: DWORD; const lpAppDesc:
      TDPApplicationDesc): HResult; stdcall;
    function UnRegisterApplication(dwFlags: DWORD; const guidApplication:
...
function DirectPlayLobbyCreateW(const lpguidSP: TGUID; out lplpDPL:
  IDirectPlayLobby;
  lpUnk: IUnknown; lpData: Pointer; dwDataSize: DWORD): HResult; stdcall;
function DirectPlayLobbyCreateA(const lpguidSP: TGUID; out lplpDPL:
  IDirectPlayLobbyA;
  lpUnk: IUnknown; lpData: Pointer; dwDataSize: DWORD): HResult; stdcall;
function DirectPlayLobbyCreate(const lpguidSP: TGUID; out lplpDPL:
  IDirectPlayLobbyA;
  lpUnk: IUnknown; lpData: Pointer; dwDataSize: DWORD): HResult; stdcall;
...
type
  ...
  TDPLMsg_SystemMessage = record
    dwType: DWORD; // Message type
    guidInstance: TGUID;
      // Instance GUID of the dplay session the message corresponds to
  end;
...
const
  FOURCC_VERS = Ord('v') + Ord('e') * $100 + Ord('r') * $10000 + Ord('s') *
    $1000000;
...
function DirectXRegisterApplicationA(hWnd: HWND; const lpDXRegApp:
  TDirectXRegisterAppA): Longint; stdcall;
function DirectXRegisterApplicationW(hWnd: HWND; const lpDXRegApp:
  TDirectXRegisterAppW): Longint; stdcall;
function DirectXRegisterApplication(hWnd: HWND; const lpDXRegApp:
  TDirectXRegisterAppA): Longint; stdcall;
function DirectXUnRegisterApplication(hWnd: HWND; const lpGUID: TGUID): Longint;
  stdcall;
...
function DirectXSetupGetVersion(var lpdwVersion, lpdwMinorVersion: DWORD):
  Longint; stdcall;
...
{$ENDIF}
  ...
  IDirectSound3DListener = interface(IUnknown)
    ...
    function GetDopplerFactor(var lpflDopplerFactor: TD3DValue): HResult;
      stdcall;
    function GetOrientation(var lpvOrientFront, lpvOrientTop: TD3DVector):
      HResult; stdcall;
    ...
    function SetAllParameters(const lpListener: TDS3DListener; dwApply: DWORD):
      HResult; stdcall;
    function SetDistanceFactor(flDistanceFactor: TD3DValue; dwApply: DWORD):
      HResult; stdcall;
    function SetDopplerFactor(flDopplerFactor: TD3DValue; dwApply: DWORD):
      HResult; stdcall;
    ...
    function SetRolloffFactor(flRolloffFactor: TD3DValue; dwApply: DWORD):
      HResult; stdcall;
  ...
  IDirectSound3DBuffer = interface(IUnknown)
    ...
    function GetPosition(var lpvPosition: TD3DVector): HResult; stdcall;
    function GetVelocity(var lpvVelocity: TD3DVector): HResult; stdcall;
    function SetAllParameters(const lpDs3dBuffer: TDS3DBuffer; dwApply: DWORD):
      HResult; stdcall;
...
const
  ...
  IID_IKsPropertySet: TGUID = (D1: $31EFAC30; D2: $515C; D3: $11D0; D4: ($A9,
    $AA, $00, $AA, $00, $61, $BE, $93));
...
function DirectSoundCreate(lpGUID: PGUID; out lpDS: IDirectSound; pUnkOuter:
  IUnknown): HResult; stdcall;
function DirectSoundEnumerateA(lpDSEnumCallback: TDSEnumCallbackA; lpContext:
  Pointer): HResult; stdcall;
function DirectSoundEnumerateW(lpDSEnumCallback: TDSEnumCallbackW; lpContext:
  Pointer): HResult; stdcall;
function DirectSoundEnumerate(lpDSEnumCallback: TDSEnumCallbackA; lpContext:
  Pointer): HResult; stdcall;

function DirectSoundCaptureCreate(lpGUID: PGUID; out lplpDSC:
  IDirectSoundCapture; pUnkOuter: IUnknown): HResult; stdcall;
function DirectSoundCaptureEnumerateA(lpDSEnumCallback: TDSEnumCallbackA;
  lpContext: Pointer): HResult; stdcall;
function DirectSoundCaptureEnumerateW(lpDSEnumCallback: TDSEnumCallbackW;
  lpContext: Pointer): HResult; stdcall;
function DirectSoundCaptureEnumerate(lpDSEnumCallback: TDSEnumCallbackA;
  lpContext: Pointer): HResult; stdcall;
...
type
  ...
  TDMUS_DOWNLOADINFO = record
    ...
    dwNumOffsetTableEntries: DWORD;
      // Number of index in the offset address table.
...
type
  ...
  TDMUS_INSTRUMENT = record
    ...
    ulGlobalArtIdx: Cardinal;
      // If zero the instrument does not have an articulation
    ulFirstExtCkIdx: Cardinal;
      // If zero no 3rd party entenstion chunks associated with the instrument
    ulCopyrightIdx: Cardinal;
      // If zero no Copyright information associated with the instrument
    ulFlags: Cardinal;
  end;
  ...
  TDMUS_REGION = record
    ...
    fusOptions: Word;
    usKeyGroup: Word;
    ulRegionArtIdx: Cardinal;
      // If zero the region does not have an articulation
    ulNextRegionIdx: Cardinal; // If zero no more regions
    ulFirstExtCkIdx: Cardinal;
      // If zero no 3rd party entenstion chunks associated with the region
    WaveLink: WAVELINK;
  ...
  TDMUS_ARTICULATION = record
    ...
    ulFirstExtCkIdx: Cardinal;
      // If zero no 3rd party entenstion chunks associated with the articulation
...
type
  TDMUS_EXTENSIONCHUNK = record
    ...
    ExtCkID: FOURCC;
    byExtCk: array[0..DMUS_MIN_DATA_SIZE - 1] of Byte;
      //  The actual number that follows is determined by cbSize
  end;
  ...
  TDMUS_COPYRIGHT = record
    ...
    byCopyright: array[0..DMUS_MIN_DATA_SIZE - 1] of Byte;
      //  The actual number that follows is determined by cbSize
  end;
  ...
  TDMUS_WAVE = record
    ulFirstExtCkIdx: Cardinal;
      // If zero no 3rd party entenstion chunks associated with the wave
    ulCopyrightIdx: Cardinal;
      // If zero no Copyright information associated with the wave
  ...
  TDMUS_NOTERANGE = record
    dwLowNote: DWORD;
      // Sets the low note for the range of MIDI note events to which the instrument responds.
    dwHighNote: DWORD;
      // Sets the high note for the range of MIDI note events to which the instrument responds.
  end;
...
///
const
  DMUS_S_PARTIALLOAD = (0 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $091; // MAKE_DMHRESULTSUCCESS($091);
  ...
  ///
  DMUS_S_REQUEUE = (0 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE +
    $200; //MAKE_DMHRESULTSUCCESS(0x200)
  ...
  ///
  DMUS_S_FREE = (0 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE + $201;
    //MAKE_DMHRESULTSUCCESS(0x201)
  ...
  ///
  DMUS_S_END = (0 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE + $202;
    //MAKE_DMHRESULTSUCCESS(0x202)

  // DMUS_S_STRING_TRUNCATED
  //
  // Returned string has been truncated to fit the buffer size.
  ///
  DMUS_S_STRING_TRUNCATED = (0 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $210; //MAKE_DMHRESULTSUCCESS(0x210)
  ...
  ///
  DMUS_S_LAST_TOOL = (0 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE +
    $211; //MAKE_DMHRESULTSUCCESS(0x211)
  ...
  ///
  DMUS_S_OVER_CHORD = (0 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $212; //MAKE_DMHRESULTSUCCESS(0x212)
  ...
  ///
  DMUS_S_UP_OCTAVE = (0 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE +
    $213; //MAKE_DMHRESULTSUCCESS(0x213)
  ...
  // Ofcourse, DMUS_PLAYMODE_FIXED will never return this success code.
  ///
  DMUS_S_DOWN_OCTAVE = (0 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $214; //MAKE_DMHRESULTSUCCESS(0x214)
  ...
  ///
  DMUS_E_DRIVER_FAILED = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0101; //MAKE_DMHRESULTERROR(0x0101)
  ...
  ///
  DMUS_E_PORTS_OPEN = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $0102; //MAKE_DMHRESULTERROR(0x0102)
  ...
  ///
  DMUS_E_DEVICE_IN_USE = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0103; //MAKE_DMHRESULTERROR(0x0103)

  // DMUS_E_INSUFFICIENTBUFFER
  //
  // Buffer is not large enough for requested operation.
  ///
  DMUS_E_INSUFFICIENTBUFFER = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0104; //MAKE_DMHRESULTERROR(0x0104)

  // DMUS_E_BUFFERNOTSET
  //
  // No buffer was prepared for the download data.
  ///
  DMUS_E_BUFFERNOTSET = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $0105; //MAKE_DMHRESULTERROR(0x0105)

  // DMUS_E_BUFFERNOTAVAILABLE
  //
  // Download failed due to inability to access or create download buffer.
  ///
  DMUS_E_BUFFERNOTAVAILABLE = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0106; //MAKE_DMHRESULTERROR(0x0106)

  // DMUS_E_NOTADLSCOL
  //
  // Error parsing DLS collection. File is corrupt.
  ///
  DMUS_E_NOTADLSCOL = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $0108; //MAKE_DMHRESULTERROR(0x0108)

  // DMUS_E_INVALIDOFFSET
  //
  // Wave chunks in DLS collection file are at incorrect offsets.
  ///
  DMUS_E_INVALIDOFFSET = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0109; //MAKE_DMHRESULTERROR(0x0109)

  // DMUS_E_ALREADY_LOADED
  //
  // Second attempt to load a DLS collection that is currently open.
  ///
  DMUS_E_ALREADY_LOADED = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0111; //MAKE_DMHRESULTERROR(0x0111)

  // DMUS_E_INVALIDPOS
  //
  // Error reading wave data from DLS collection. Indicates bad file.
  ///
  DMUS_E_INVALIDPOS = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $0113; //MAKE_DMHRESULTERROR(0x0113)

  // DMUS_E_INVALIDPATCH
  //
  // There is no instrument in the collection that matches patch number.
  ///
  DMUS_E_INVALIDPATCH = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $0114; //MAKE_DMHRESULTERROR(0x0114)

  // DMUS_E_CANNOTSEEK
  //
  // The IStream* doesn't support Seek().
  ///
  DMUS_E_CANNOTSEEK = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $0115; //MAKE_DMHRESULTERROR(0x0115)

  // DMUS_E_CANNOTWRITE
  //
  // The IStream* doesn't support Write().
  ///
  DMUS_E_CANNOTWRITE = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $0116; //MAKE_DMHRESULTERROR(0x0116)

  // DMUS_E_CHUNKNOTFOUND
  //
  // The RIFF parser doesn't contain a required chunk while parsing file.
  ///
  DMUS_E_CHUNKNOTFOUND = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0117; //MAKE_DMHRESULTERROR(0x0117)

  // DMUS_E_INVALID_DOWNLOADID
  //
  // Invalid download id was used in the process of creating a download buffer.
  ///
  DMUS_E_INVALID_DOWNLOADID = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0119; //MAKE_DMHRESULTERROR(0x0119)

  // DMUS_E_NOT_DOWNLOADED_TO_PORT
  //
  // Tried to unload an object that was not downloaded or previously unloaded.
  ///
  DMUS_E_NOT_DOWNLOADED_TO_PORT = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0120; //MAKE_DMHRESULTERROR(0x0120)

  // DMUS_E_ALREADY_DOWNLOADED
  //
  // Buffer was already downloaded to synth.
  ///
  DMUS_E_ALREADY_DOWNLOADED = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0121; //MAKE_DMHRESULTERROR(0x0121)

  // DMUS_E_UNKNOWN_PROPERTY
  //
  // The specified property item was not recognized by the target object.
  ///
  DMUS_E_UNKNOWN_PROPERTY = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0122; //MAKE_DMHRESULTERROR(0x0122)

  // DMUS_E_SET_UNSUPPORTED
  //
  // The specified property item may not be set on the target object.
  ///
  DMUS_E_SET_UNSUPPORTED = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0123; //MAKE_DMHRESULTERROR(0x0123)

  // DMUS_E_GET_UNSUPPORTED
  //
  // The specified property item may not be retrieved from the target object.
  ///
  DMUS_E_GET_UNSUPPORTED = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0124; //MAKE_DMHRESULTERROR(0x0124)

  // DMUS_E_NOTMONO
  //
  // Wave chunk has more than one interleaved channel. DLS format requires MONO.
  ///
  DMUS_E_NOTMONO = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE +
    $0125; //MAKE_DMHRESULTERROR(0x0125)

  // DMUS_E_BADARTICULATION
  //
  // Invalid articulation chunk in DLS collection.
  ///
  DMUS_E_BADARTICULATION = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0126; //MAKE_DMHRESULTERROR(0x0126)

  // DMUS_E_BADINSTRUMENT
  //
  // Invalid instrument chunk in DLS collection.
  ///
  DMUS_E_BADINSTRUMENT = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0127; //MAKE_DMHRESULTERROR(0x0127)

  // DMUS_E_BADWAVELINK
  //
  // Wavelink chunk in DLS collection points to invalid wave.
  ///
  DMUS_E_BADWAVELINK = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $0128; //MAKE_DMHRESULTERROR(0x0128)

  // DMUS_E_NOARTICULATION
  //
  // Articulation missing from instrument in DLS collection.
  ///
  DMUS_E_NOARTICULATION = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0129; //MAKE_DMHRESULTERROR(0x0129)

  // DMUS_E_NOTPCM
  //
  // Downoaded DLS wave is not in PCM format.
  ///
  DMUS_E_NOTPCM = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE +
    $012A; //MAKE_DMHRESULTERROR(0x012A)

  // DMUS_E_BADWAVE
  //
  // Bad wave chunk in DLS collection
  ///
  DMUS_E_BADWAVE = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE +
    $012B; //MAKE_DMHRESULTERROR(0x012B)

  // DMUS_E_BADOFFSETTABLE
  //
  // Offset Table for download buffer has errors.
  ///
  DMUS_E_BADOFFSETTABLE = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $012C; //MAKE_DMHRESULTERROR(0x012C)

  // DMUS_E_UNKNOWNDOWNLOAD
  //
  // Attempted to download unknown data type.
  ///
  DMUS_E_UNKNOWNDOWNLOAD = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $012D; //MAKE_DMHRESULTERROR(0x012D)
  ...
  // the synthesizer.
  ///
  DMUS_E_NOSYNTHSINK = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $012E; //MAKE_DMHRESULTERROR(0x012E)
  ...
  // ASSERT?
  ///
  DMUS_E_ALREADYOPEN = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $012F; //MAKE_DMHRESULTERROR(0x012F)
  ...
  // ASSERT?
  ///
  DMUS_E_ALREADYCLOSED = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0130; //MAKE_DMHRESULTERROR(0x0130)
  ...
  // ASSERT?
  ///
  DMUS_E_SYNTHNOTCONFIGURED = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0131; //MAKE_DMHRESULTERROR(0x0131)

  // DMUS_E_SYNTHACTIVE
  //
  // The operation cannot be carried out while the synthesizer is active.
  ///
  DMUS_E_SYNTHACTIVE = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $0132; //MAKE_DMHRESULTERROR(0x0132)

  // DMUS_E_CANNOTREAD
  //
  // An error occurred while attempting to read from the IStream* object.
  ///
  DMUS_E_CANNOTREAD = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $0133; //MAKE_DMHRESULTERROR(0x0133)
  ...
  ///
  DMUS_E_DMUSIC_RELEASED = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0134; //MAKE_DMHRESULTERROR(0x0134)

  // DMUS_E_BUFFER_EMPTY
  //
  // There was no data in the referenced buffer.
  ///
  DMUS_E_BUFFER_EMPTY = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $0135; //MAKE_DMHRESULTERROR(0x0135)

  // DMUS_E_BUFFER_FULL
  //
  // There is insufficient space to insert the given event into the buffer.
  ///
  DMUS_E_BUFFER_FULL = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $0136; //MAKE_DMHRESULTERROR(0x0136)
  ...
  // capture port.
  ///
  DMUS_E_PORT_NOT_CAPTURE = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0137; //MAKE_DMHRESULTERROR(0x0137)
  ...
  // render port.
  ///
  DMUS_E_PORT_NOT_RENDER = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0138; //MAKE_DMHRESULTERROR(0x0138)
  ...
  ///
  DMUS_E_DSOUND_NOT_SET = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0139; //MAKE_DMHRESULTERROR(0x0139)

  // DMUS_E_ALREADY_ACTIVATED
  //
  // The operation cannot be carried out while the port is active.
  ///
  DMUS_E_ALREADY_ACTIVATED = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $013A; //MAKE_DMHRESULTERROR(0x013A)

  // DMUS_E_INVALIDBUFFER
  //
  // Invalid DirectSound buffer was handed to port.
  ///
  DMUS_E_INVALIDBUFFER = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $013B; //MAKE_DMHRESULTERROR(0x013B)

  // DMUS_E_WAVEFORMATNOTSUPPORTED
  //
  // Invalid buffer format was handed to the synth sink.
  ///
  DMUS_E_WAVEFORMATNOTSUPPORTED = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $013C; //MAKE_DMHRESULTERROR(0x013C)

  // DMUS_E_SYNTHINACTIVE
  //
  // The operation cannot be carried out while the synthesizer is inactive.
  ///
  DMUS_E_SYNTHINACTIVE = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $013D; //MAKE_DMHRESULTERROR(0x013D)
  ...
  ///
  DMUS_E_DSOUND_ALREADY_SET = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $013E; //MAKE_DMHRESULTERROR(0x013E)
  ...
  // into the buffer.
  ///
  DMUS_E_INVALID_EVENT = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $013F; //MAKE_DMHRESULTERROR(0x013F)

  // DMUS_E_UNSUPPORTED_STREAM
  //
  // The IStream* object does not contain data supported by the loading object.
  ///
  DMUS_E_UNSUPPORTED_STREAM = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0150; //MAKE_DMHRESULTERROR(0x0150)

  // DMUS_E_ALREADY_INITED
  //
  // The object has already been initialized.
  ///
  DMUS_E_ALREADY_INITED = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0151; //MAKE_DMHRESULTERROR(0x0151)

  // DMUS_E_INVALID_BAND
  //
  // The file does not contain a valid band.
  ///
  DMUS_E_INVALID_BAND = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $0152; //MAKE_DMHRESULTERROR(0x0152)
  ...
  ///
  DMUS_E_TRACK_HDR_NOT_FIRST_CK = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0155; //MAKE_DMHRESULTERROR(0x0155)
  ...
  ///
  DMUS_E_TOOL_HDR_NOT_FIRST_CK = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0156; //MAKE_DMHRESULTERROR(0x0156)
  ...
  ///
  DMUS_E_INVALID_TRACK_HDR = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0157; //MAKE_DMHRESULTERROR(0x0157)
  ...
  ///
  DMUS_E_INVALID_TOOL_HDR = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0158; //MAKE_DMHRESULTERROR(0x0158)
  ...
  ///
  DMUS_E_ALL_TOOLS_FAILED = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0159; //MAKE_DMHRESULTERROR(0x0159)
  ...
  // registered on the client.
  ///
  DMUS_E_ALL_TRACKS_FAILED = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0160; //MAKE_DMHRESULTERROR(0x0160)

  // DMUS_E_NOT_FOUND
  //
  // The requested item was not contained by the object.
  ///
  DMUS_E_NOT_FOUND = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE +
    $0161; //MAKE_DMHRESULTERROR(0x0161)

  // DMUS_E_NOT_INIT
  //
  // A required object is not initialized or failed to initialize.
  ///
  DMUS_E_NOT_INIT = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE +
    $0162; //MAKE_DMHRESULTERROR(0x0162)
  ...
  ///
  DMUS_E_TYPE_DISABLED = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0163; //MAKE_DMHRESULTERROR(0x0163)

  // DMUS_E_TYPE_UNSUPPORTED
  //
  // The requested parameter type is not supported on the object.
  ///
  DMUS_E_TYPE_UNSUPPORTED = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0164; //MAKE_DMHRESULTERROR(0x0164)

  // DMUS_E_TIME_PAST
  //
  // The time is in the past, and the operation can not succeed.
  ///
  DMUS_E_TIME_PAST = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE +
    $0165; //MAKE_DMHRESULTERROR(0x0165)

  // DMUS_E_TRACK_NOT_FOUND
  //
  // The requested track is not contained by the segment.
  ///
  DMUS_E_TRACK_NOT_FOUND = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0166; //MAKE_DMHRESULTERROR(0x0166)
  ...
  ///
  DMUS_E_NO_MASTER_CLOCK = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0170; //MAKE_DMHRESULTERROR(0x0170)

  // DMUS_E_LOADER_NOCLASSID
  //
  // The class id field is required and missing in the DMUS_OBJECTDESC.
  ///
  DMUS_E_LOADER_NOCLASSID = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0180; //MAKE_DMHRESULTERROR(0x0180)

  // DMUS_E_LOADER_BADPATH
  //
  // The requested file path is invalid.
  ///
  DMUS_E_LOADER_BADPATH = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0181; //MAKE_DMHRESULTERROR(0x0181)

  // DMUS_E_LOADER_FAILEDOPEN
  //
  // File open failed - either file doesn't exist or is locked.
  ///
  DMUS_E_LOADER_FAILEDOPEN = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0182; //MAKE_DMHRESULTERROR(0x0182)

  // DMUS_E_LOADER_FORMATNOTSUPPORTED
  //
  // Search data type is not supported.
  ///
  DMUS_E_LOADER_FORMATNOTSUPPORTED = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16)
    + DMUS_ERRBASE + $0183; //MAKE_DMHRESULTERROR(0x0183)

  // DMUS_E_LOADER_FAILEDCREATE
  //
  // Unable to find or create object.
  ///
  DMUS_E_LOADER_FAILEDCREATE = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0184; //MAKE_DMHRESULTERROR(0x0184)

  // DMUS_E_LOADER_OBJECTNOTFOUND
  //
  // Object was not found.
  ///
  DMUS_E_LOADER_OBJECTNOTFOUND = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0185; //MAKE_DMHRESULTERROR(0x0185)

  // DMUS_E_LOADER_NOFILENAME
  //
  // The file name is missing from the DMUS_OBJECTDESC.
  ///
  DMUS_E_LOADER_NOFILENAME = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0186; //MAKE_DMHRESULTERROR(0x0186)

  // DMUS_E_INVALIDFILE
  //
  // The file requested is not a valid file.
  ///
  DMUS_E_INVALIDFILE = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $0200; //MAKE_DMHRESULTERROR(0x0200)

  // DMUS_E_ALREADY_EXISTS
  //
  // The tool is already contained in the graph. Create a new instance.
  ///
  DMUS_E_ALREADY_EXISTS = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0201; //MAKE_DMHRESULTERROR(0x0201)
  ...
  // the segment.
  ///
  DMUS_E_OUT_OF_RANGE = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $0202; //MAKE_DMHRESULTERROR(0x0202)

  // DMUS_E_SEGMENT_INIT_FAILED
  //
  // Segment initialization failed, most likely due to a critical memory situation.
  ///
  DMUS_E_SEGMENT_INIT_FAILED = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0203; //MAKE_DMHRESULTERROR(0x0203)
  ...
  ///
  DMUS_E_ALREADY_SENT = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $0204; //MAKE_DMHRESULTERROR(0x0204)
  ...
  ///
  DMUS_E_CANNOT_FREE = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) + DMUS_ERRBASE
    + $0205; //MAKE_DMHRESULTERROR(0x0205)

  // DMUS_E_CANNOT_OPEN_PORT
  //
  // The default system port could not be opened.
  ///
  DMUS_E_CANNOT_OPEN_PORT = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0206; //MAKE_DMHRESULTERROR(0x0206)
  ...
  ///
  DMUS_E_CONNOT_CONVERT = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0207; //MAKE_DMHRESULTERROR(0x0207)
  ...
  ///
  DMUS_E_DESCEND_CHUNK_FAIL = (1 shl 31) + (FACILITY_DIRECTMUSIC shl 16) +
    DMUS_ERRBASE + $0210; //MAKE_DMHRESULTERROR(0x0210)
...
type
  IKsControl = interface(IUnknown)
    ...
    //IKsControl
    function KsProperty(const _Property: TKSPROPERTY; PropertyLength: Cardinal;
      var PropertyData;
      DataLength: Cardinal; var BytesReturned: Cardinal): HResult; stdcall;
    function KsMethod(const Method: TKSMETHOD; MethodLength: Cardinal; var
      PropertyData;
      DataLength: Cardinal; var BytesReturned: Cardinal): HResult; stdcall;
    function KsEvent(const Event: TKSEVENT; EventLength: Cardinal; var
      EventData;
      DataLength: Cardinal; var BytesReturned: Cardinal): HResult; stdcall;
  end;
...
const
  ...
  KSDATAFORMAT_SUBTYPE_DIRECTMUSIC: TGUID =
    '{1A82F8BC-3F8B-11D2-B774-0060083316C1}';
...
function DMUS_EVENT_SIZE(cb: LONGLONG): LONGLONG;
  //QWORD_ALIGN(sizeof(DMUS_EVENTHEADER) + cb)
...
type
  TDMUS_WAVES_REVERB_PARAMS = record
    ...
    fReverbMix: Single;
      // Reverb mix in dB. 0dB means 100% wet reverb (no direct signal)
    //Negative values gives less wet signal.
    //The coeficients are calculated so that the overall output level stays
    //(approximately) constant regardless of the ammount of reverb mix.
    fReverbTime: Single; // The reverb decay time, in milliseconds.
    fHighFreqRTRatio: Single;
      // The ratio of the high frequencies to the global reverb time.
...
type
  ...
  IDirectMusic = interface(IUnknown)
    ...
    //  IDirectMusic
    function EnumPort(dwIndex: DWORD; var pPortCaps: TDMUS_PORTCAPS): HResult;
      stdcall;
    function CreateMusicBuffer(const pBufferDesc: TDMUS_BUFFERDESC; out
      ppBuffer: IDirectMusicBuffer;
      pUnkOuter: IUnknown): HResult; stdcall;
    function CreatePort(const rclsidPort: TGUID; const pPortParams:
      TDMUS_PORTPARAMS;
      out ppPort: IDirectMusicPort; pUnkOuter: IUnknown): HResult; stdcall;
    function EnumMasterClock(dwIndex: DWORD; var lpClockInfo: TDMUS_CLOCKINFO):
      HResult; stdcall;
    function GetMasterClock(pguidClock: PGUID; out ppReferenceClock:
      IReferenceClock): HResult; stdcall;
    ...
    function SetDirectSound(pDirectSound: IDirectSound; hWnd: HWND): HResult;
      stdcall;
  end;
  ...
  IDirectMusicCollection = interface(IUnknown)
    ...
    function GetInstrument(dwPatch: DWORD; out ppInstrument:
      IDirectMusicInstrument): HResult; stdcall;
  ...
  IDirectMusicDownload = interface(IUnknown)
    ...
    function GetBuffer(var ppvBuffer: Pointer; var pdwSize: DWORD): HResult;
      stdcall;
  end;
  ...
  IDirectMusicPortDownload = interface(IUnknown)
    ...
    function GetBuffer(dwDLId: DWORD; out ppIDMDownload: IDirectMusicDownload):
      HResult; stdcall;
  ...
  IDirectMusicPort = interface(IUnknown)
    ...
    function UnloadInstrument(pDownloadedInstrument:
      IDirectMusicDownloadedInstrument): HResult; stdcall;
    ...
    function SetChannelPriority(dwChannelGroup: DWORD; dwChannel: DWORD;
      dwPriority: DWORD): HResult; stdcall;
    function GetChannelPriority(dwChannelGroup: DWORD; dwChannel: DWORD; var
      pdwPriority: DWORD): HResult; stdcall;
    function SetDirectSound(pDirectSound: IDirectSound; pDirectSoundBuffer:
      IDirectSoundBuffer): HResult; stdcall;
    function GetFormat(var pWaveFormatEx: TWAVEFORMATEX; var
      pdwWaveFormatExSize: DWORD; var pdwBufferSize: DWORD): HResult; stdcall;
  end;
...
const
  ...
  DAUD_CHAN1_DEF_VOICE_PRIORITY = (DAUD_STANDARD_VOICE_PRIORITY or
    DAUD_CHAN1_VOICE_PRIORITY_OFFSET);
  DAUD_CHAN2_DEF_VOICE_PRIORITY = (DAUD_STANDARD_VOICE_PRIORITY or
    DAUD_CHAN2_VOICE_PRIORITY_OFFSET);
  DAUD_CHAN3_DEF_VOICE_PRIORITY = (DAUD_STANDARD_VOICE_PRIORITY or
    DAUD_CHAN3_VOICE_PRIORITY_OFFSET);
  DAUD_CHAN4_DEF_VOICE_PRIORITY = (DAUD_STANDARD_VOICE_PRIORITY or
    DAUD_CHAN4_VOICE_PRIORITY_OFFSET);
  DAUD_CHAN5_DEF_VOICE_PRIORITY = (DAUD_STANDARD_VOICE_PRIORITY or
    DAUD_CHAN5_VOICE_PRIORITY_OFFSET);
  DAUD_CHAN6_DEF_VOICE_PRIORITY = (DAUD_STANDARD_VOICE_PRIORITY or
    DAUD_CHAN6_VOICE_PRIORITY_OFFSET);
  DAUD_CHAN7_DEF_VOICE_PRIORITY = (DAUD_STANDARD_VOICE_PRIORITY or
    DAUD_CHAN7_VOICE_PRIORITY_OFFSET);
  DAUD_CHAN8_DEF_VOICE_PRIORITY = (DAUD_STANDARD_VOICE_PRIORITY or
    DAUD_CHAN8_VOICE_PRIORITY_OFFSET);
  DAUD_CHAN9_DEF_VOICE_PRIORITY = (DAUD_STANDARD_VOICE_PRIORITY or
    DAUD_CHAN9_VOICE_PRIORITY_OFFSET);
  DAUD_CHAN10_DEF_VOICE_PRIORITY = (DAUD_STANDARD_VOICE_PRIORITY or
    DAUD_CHAN10_VOICE_PRIORITY_OFFSET);
  DAUD_CHAN11_DEF_VOICE_PRIORITY = (DAUD_STANDARD_VOICE_PRIORITY or
    DAUD_CHAN11_VOICE_PRIORITY_OFFSET);
  DAUD_CHAN12_DEF_VOICE_PRIORITY = (DAUD_STANDARD_VOICE_PRIORITY or
    DAUD_CHAN12_VOICE_PRIORITY_OFFSET);
  DAUD_CHAN13_DEF_VOICE_PRIORITY = (DAUD_STANDARD_VOICE_PRIORITY or
    DAUD_CHAN13_VOICE_PRIORITY_OFFSET);
  DAUD_CHAN14_DEF_VOICE_PRIORITY = (DAUD_STANDARD_VOICE_PRIORITY or
    DAUD_CHAN14_VOICE_PRIORITY_OFFSET);
  DAUD_CHAN15_DEF_VOICE_PRIORITY = (DAUD_STANDARD_VOICE_PRIORITY or
    DAUD_CHAN15_VOICE_PRIORITY_OFFSET);
  DAUD_CHAN16_DEF_VOICE_PRIORITY = (DAUD_STANDARD_VOICE_PRIORITY or
  ...
  GUID_DMUS_PROP_SynthSink_DSOUND: TGUID =
    '{0AA97844-C877-11D1-870C-00600893B1BD}';
  GUID_DMUS_PROP_SynthSink_WAVE: TGUID =
    '{0AA97845-C877-11D1-870C-00600893B1BD}';
...
const
  ...
  DMUS_PMSGF_TOOL_QUEUE = 8;
    // if PMSG should be processed a little early, at Queue time
...
const
  ...
  DMUS_SEGF_QUEUE = 256;
    // queue at the end of the primary segment queue (primary only)
  ...
  DMUS_SEGF_NOINVALIDATE = 1 shl 15;
    // play without invalidating the currently playing segment(s)
...
const
  ...
  DMUS_TIME_RESOLVE_AFTERPREPARETIME = 1 shl 10;
  ...
  DMUS_TIME_RESOLVE_MEASURE = 1 shl 13;
...
const
  ...
  DMUS_TRACKF_FLUSH = 8;
    // set when this call is in response to a flush on the perfomance
  DMUS_TRACKF_DIRTY = 16;
    // set when the track should consider any cached values from a previous call to GetParam to be invalidated
...
type
  ...
  TDMUS_CHORD_KEY = record
    ...
    SubChordList: array[0..DMUS_MAXSUBCHORD - 1] of TDMUS_SUBCHORD;
      // List of sub chords
...
const
  ...
  DMUS_NOTEF_NOTEON = 1;
    // Set if this is a MIDI Note On. Otherwise, it is MIDI Note Off
...
const
  ...
  DMUS_PLAYMODE_NONE = 16;
    // No mode. Indicates the parent part's mode should be used.
...
const
  ...
  ///
  DMUS_PLAYMODE_PEDALPOINT = (DMUS_PLAYMODE_KEY_ROOT or
  ...
  ///
  DMUS_PLAYMODE_MELODIC = (DMUS_PLAYMODE_CHORD_ROOT or
    DMUS_PLAYMODE_SCALE_INTERVALS);
  ...
  ///
  DMUS_PLAYMODE_NORMALCHORD = (DMUS_PLAYMODE_CHORD_ROOT or
  ...
  ///
  DMUS_PLAYMODE_ALWAYSPLAY = (DMUS_PLAYMODE_MELODIC or
...
type
  ...
  TDMUS_PMSG_PART = record
    dwSize: DWORD;
    rtTime: REFERENCE_TIME;
      // real time (in 100 nanosecond increments)           \
    ...
    dwVirtualTrackID: DWORD;
      // virtual track ID                                   \
    pTool: IDirectMusicTool;
      // tool interface pointer                             \
    pGraph: IDirectMusicGraph;
  ...
  TDMUS_NOTE_PMSG = record
    ...
    cTranspose: Shortint;
      // Transposition to add to midi note value after converted from wMusicValue.
  end;
  ...
  TDMUS_OBJECTDESC = record
    ...
    wszCategory: array[0..DMUS_MAX_CATEGORY - 1] of WCHAR;
  ...
  IDirectMusicBand = interface(IUnknown)
    ...
    // IDirectMusicBand
    function CreateSegment(out ppSegment: IDirectMusicSegment): HResult;
      stdcall;
  ...
  IDirectMusicSegment = interface(IUnknown)
    ...
    function AddNotificationType(const rguidNotificationType: TGUID): HResult;
      stdcall;
    function RemoveNotificationType(const rguidNotificationType: TGUID): HResult;
      stdcall;
  ...
  IDirectMusicPerformance = interface(IUnknown)
    ...
    function GetNotificationPMsg(var ppNotificationPMsg:
      PDMUS_NOTIFICATION_PMSG): HResult; stdcall;
    function AddNotificationType(const rguidNotificationType: TGUID): HResult;
      stdcall;
    function RemoveNotificationType(const rguidNotificationType: TGUID): HResult;
      stdcall;
  ...
  IDirectMusicStyle = interface(IUnknown)
    ...
    function GetMotif(pwszName: PWCHAR;
      out ppSegment: IDirectMusicSegment): HResult; stdcall;
    function GetDefaultChordMap(out ppChordMap: IDirectMusicChordMap): HResult;
      stdcall;
    ...
    function GetTimeSignature(var pTimeSig: TDMUS_TIMESIGNATURE): HResult;
      stdcall;
...
const
  ...
  GUID_NOTIFICATION_MEASUREANDBEAT: TGUID =
    '{D2AC289A-B39B-11D1-8704-00600893B1BD}';
  ...
  GUID_IgnoreBankSelectForGM: TGUID = '{06621075-E92E-11D1-A8C5-00C04FA3726E}';
    //same as GUID_StandardMIDIFile;
  ...
  IID_IDirectMusicPerformance2: TGUID =
    '{6FC2CAE0-BC78-11D2-AFA6-00AA0024D8B6}';
  ...
  // Common chunks
const
  DMUS_FOURCC_GUID_CHUNK = Ord('g') + Ord('u') shl 8 + Ord('i') shl 16 + Ord('d')
    shl 24;
  DMUS_FOURCC_INFO_LIST = Ord('I') + Ord('N') shl 8 + Ord('F') shl 16 + Ord('O')
    shl 24;
  DMUS_FOURCC_UNFO_LIST = Ord('U') + Ord('N') shl 8 + Ord('F') shl 16 + Ord('O')
    shl 24;
  DMUS_FOURCC_UNAM_CHUNK = Ord('U') + Ord('N') shl 8 + Ord('A') shl 16 + Ord('M')
    shl 24;
  DMUS_FOURCC_UART_CHUNK = Ord('U') + Ord('A') shl 8 + Ord('R') shl 16 + Ord('T')
    shl 24;
  DMUS_FOURCC_UCOP_CHUNK = Ord('U') + Ord('C') shl 8 + Ord('O') shl 16 + Ord('P')
    shl 24;
  DMUS_FOURCC_USBJ_CHUNK = Ord('U') + Ord('S') shl 8 + Ord('B') shl 16 + Ord('J')
    shl 24;
  DMUS_FOURCC_UCMT_CHUNK = Ord('U') + Ord('C') shl 8 + Ord('M') shl 16 + Ord('T')
    shl 24;
  DMUS_FOURCC_CATEGORY_CHUNK = Ord('c') + Ord('a') shl 8 + Ord('t') shl 16 +
    Ord('g') shl 24;
  DMUS_FOURCC_VERSION_CHUNK = Ord('v') + Ord('e') shl 8 + Ord('r') shl 16 +
    Ord('s') shl 24;
...
const
  ...
  DMUS_FOURCC_STYLE_FORM = Ord('D') + Ord('M') shl 8 + Ord('S') shl 16 + Ord('T')
    shl 24;
  DMUS_FOURCC_STYLE_CHUNK = Ord('s') + Ord('t') shl 8 + Ord('y') shl 16 +
    Ord('h') shl 24;
  DMUS_FOURCC_PART_LIST = Ord('p') + Ord('a') shl 8 + Ord('r') shl 16 + Ord('t')
    shl 24;
  DMUS_FOURCC_PART_CHUNK = Ord('p') + Ord('r') shl 8 + Ord('t') shl 16 + Ord('h')
    shl 24;
  DMUS_FOURCC_NOTE_CHUNK = Ord('n') + Ord('o') shl 8 + Ord('t') shl 16 + Ord('e')
    shl 24;
  DMUS_FOURCC_CURVE_CHUNK = Ord('c') + Ord('r') shl 8 + Ord('v') shl 16 +
    Ord('e') shl 24;
  DMUS_FOURCC_PATTERN_LIST = Ord('p') + Ord('t') shl 8 + Ord('t') shl 16 +
    Ord('n') shl 24;
  DMUS_FOURCC_PATTERN_CHUNK = Ord('p') + Ord('t') shl 8 + Ord('n') shl 16 +
    Ord('h') shl 24;
  DMUS_FOURCC_RHYTHM_CHUNK = Ord('r') + Ord('h') shl 8 + Ord('t') shl 16 +
    Ord('m') shl 24;
  DMUS_FOURCC_PARTREF_LIST = Ord('p') + Ord('r') shl 8 + Ord('e') shl 16 +
    Ord('f') shl 24;
  DMUS_FOURCC_PARTREF_CHUNK = Ord('p') + Ord('r') shl 8 + Ord('f') shl 16 +
    Ord('c') shl 24;
  DMUS_FOURCC_STYLE_PERS_REF_LIST = Ord('p') + Ord('r') shl 8 + Ord('r') shl 16
    + Ord('f') shl 24;
  DMUS_FOURCC_MOTIFSETTINGS_CHUNK = Ord('m') + Ord('t') shl 8 + Ord('f') shl 16
    + Ord('s') shl 24;
  ...
  // respectively.
  DMUS_VARIATIONF_MAJOR = $0000007F;
    // Seven positions in the scale - major chords.
  DMUS_VARIATIONF_MINOR = $00003F80;
    // Seven positions in the scale - minor chords.
  DMUS_VARIATIONF_OTHER = $001FC000;
    // Seven positions in the scale - other chords.
  DMUS_VARIATIONF_ROOT_SCALE = $00200000; // Handles chord roots in the scale.
  DMUS_VARIATIONF_ROOT_FLAT = $00400000;
    // Handles flat chord roots (based on scale notes).
  DMUS_VARIATIONF_ROOT_SHARP = $00800000;
...
type
  ...
  TDMUS_IO_PARTREF = record
    ...
    // notes
    bRandomVariation: Byte;
      // when set, matching variations play in random order
  ...
  TDMUS_IO_STYLECURVE = record
    ...
    mtDuration: MUSIC_TIME; // how long this curve lasts
    mtResetDuration: MUSIC_TIME;
      // how long after the end of the curve to reset the curve
    nTimeOffset: Smallint; // offset from mtGridStart
    nStartValue: Smallint; // curve's start value
    nEndValue: Smallint; // curve's end value
  ...
  TDMUS_IO_MOTIFSETTINGS = record
    ...
    mtLoopEnd: MUSIC_TIME;
      // End of loop. Must be greater than mtLoopStart. By default equal to length of motif.
...
const
  ...
  DMUS_FOURCC_CHORDTRACK_LIST = Ord('c') + Ord('o') shl 8 + Ord('r') shl 16 +
    Ord('d') shl 24;
  DMUS_FOURCC_CHORDTRACKHEADER_CHUNK = Ord('c') + Ord('r') shl 8 + Ord('d') shl
    16 + Ord('h') shl 24;
  DMUS_FOURCC_CHORDTRACKBODY_CHUNK = Ord('c') + Ord('r') shl 8 + Ord('d') shl 16
    + Ord('b') shl 24;

  DMUS_FOURCC_COMMANDTRACK_CHUNK = Ord('c') + Ord('m') shl 8 + Ord('n') shl 16 +
    Ord('d') shl 24;
...
const
  ...
  DMUS_FOURCC_TOOLGRAPH_FORM = Ord('D') + Ord('M') shl 8 + Ord('T') shl 16 +
    Ord('G') shl 24;
  DMUS_FOURCC_TOOL_LIST = Ord('t') + Ord('o') shl 8 + Ord('l') shl 16 + Ord('l')
    shl 24;
  DMUS_FOURCC_TOOL_FORM = Ord('D') + Ord('M') shl 8 + Ord('T') shl 16 + Ord('L')
    shl 24;
  DMUS_FOURCC_TOOL_CHUNK = Ord('t') + Ord('o') shl 8 + Ord('l') shl 16 + Ord('h')
    shl 24;
...
type
  ...
  TDMUS_IO_TOOL_HEADER = record
    ...
    dwPChannels: array[0..0] of DWORD;
      // Array of PChannels, size determined by cPChannels.
  end;
...
const
  // RIFF ids:
  DMUS_FOURCC_BANDTRACK_FORM = Ord('D') + Ord('M') shl 8 + Ord('B') shl 16 +
    Ord('T') shl 24;
  DMUS_FOURCC_BANDTRACK_CHUNK = Ord('b') + Ord('d') shl 8 + Ord('t') shl 16 +
    Ord('h') shl 24;
  DMUS_FOURCC_BANDS_LIST = Ord('l') + Ord('b') shl 8 + Ord('d') shl 16 + Ord('l')
    shl 24;
  DMUS_FOURCC_BAND_LIST = Ord('l') + Ord('b') shl 8 + Ord('n') shl 16 + Ord('d')
    shl 24;
  DMUS_FOURCC_BANDITEM_CHUNK = Ord('b') + Ord('d') shl 8 + Ord('i') shl 16 +
    Ord('h') shl 24;
...
const
  ...
  DMUS_FOURCC_BAND_FORM = Ord('D') + Ord('M') shl 8 + Ord('B') shl 16 + Ord('D')
    shl 24;
  DMUS_FOURCC_INSTRUMENTS_LIST = Ord('l') + Ord('b') shl 8 + Ord('i') shl 16 +
    Ord('l') shl 24;
  DMUS_FOURCC_INSTRUMENT_LIST = Ord('l') + Ord('b') shl 8 + Ord('i') shl 16 +
    Ord('n') shl 24;
  DMUS_FOURCC_INSTRUMENT_CHUNK = Ord('b') + Ord('i') shl 8 + Ord('n') shl 16 +
    Ord('s') shl 24;

  // Flags for DMUS_IO_INSTRUMENT
  ///
  DMUS_IO_INST_PATCH = (1 shl 0); // dwPatch is valid.
  DMUS_IO_INST_BANKSELECT = (1 shl 1);
    // dwPatch contains a valid Bank Select MSB and LSB part
  ...
  DMUS_IO_INST_USE_DEFAULT_GM_SET = (1 shl 12);
    // Always use the default GM set for this patch,
...
type
  ...
  TDMUS_IO_INSTRUMENT = record
    ...
    dwNoteRanges: array[0..3] of DWORD;
...
const
  ...
  DMUS_FOURCC_SEGMENT_FORM = Ord('D') + Ord('M') shl 8 + Ord('S') shl 16 +
    Ord('G') shl 24;
  DMUS_FOURCC_SEGMENT_CHUNK = Ord('s') + Ord('e') shl 8 + Ord('g') shl 16 +
    Ord('h') shl 24;
  DMUS_FOURCC_TRACK_LIST = Ord('t') + Ord('r') shl 8 + Ord('k') shl 16 + Ord('l')
    shl 24;
  DMUS_FOURCC_TRACK_FORM = Ord('D') + Ord('M') shl 8 + Ord('T') shl 16 + Ord('K')
    shl 24;
  DMUS_FOURCC_TRACK_CHUNK = Ord('t') + Ord('r') shl 8 + Ord('k') shl 16 +
    Ord('h') shl 24;
...
type
  ...
  TDMUS_IO_SEGMENT_HEADER = record
    ...
    mtLoopStart: MUSIC_TIME; // Start of looping portion. By default, 0.
    mtLoopEnd: MUSIC_TIME;
      // End of loop. Must be greater than dwPlayStart. By default equal to length.
    dwResolution: DWORD; // Default resolution.
  end;
...
const
  ...
  DMUS_FOURCC_REF_LIST = Ord('D') + Ord('M') shl 8 + Ord('R') shl 16 + Ord('F')
    shl 24;
  DMUS_FOURCC_REF_CHUNK = Ord('r') + Ord('e') shl 8 + Ord('f') shl 16 + Ord('h')
    shl 24;
  DMUS_FOURCC_DATE_CHUNK = Ord('d') + Ord('a') shl 8 + Ord('t') shl 16 + Ord('e')
    shl 24;
  DMUS_FOURCC_NAME_CHUNK = Ord('n') + Ord('a') shl 8 + Ord('m') shl 16 + Ord('e')
    shl 24;
  DMUS_FOURCC_FILE_CHUNK = Ord('f') + Ord('i') shl 8 + Ord('l') shl 16 + Ord('e')
    shl 24;
...
const
  // runtime chunks
  DMUS_FOURCC_CHORDMAP_FORM = Ord('D') + Ord('M') shl 8 + Ord('P') shl 16 +
    Ord('R') shl 24;
  DMUS_FOURCC_IOCHORDMAP_CHUNK = Ord('p') + Ord('e') shl 8 + Ord('r') shl 16 +
    Ord('h') shl 24;
  DMUS_FOURCC_SUBCHORD_CHUNK = Ord('c') + Ord('h') shl 8 + Ord('d') shl 16 +
    Ord('t') shl 24;
  DMUS_FOURCC_CHORDENTRY_CHUNK = Ord('c') + Ord('h') shl 8 + Ord('e') shl 16 +
    Ord('h') shl 24;
  DMUS_FOURCC_SUBCHORDID_CHUNK = Ord('s') + Ord('b') shl 8 + Ord('c') shl 16 +
    Ord('n') shl 24;
  DMUS_FOURCC_IONEXTCHORD_CHUNK = Ord('n') + Ord('c') shl 8 + Ord('r') shl 16 +
    Ord('d') shl 24;
  DMUS_FOURCC_NEXTCHORDSEQ_CHUNK = Ord('n') + Ord('c') shl 8 + Ord('s') shl 16 +
    Ord('q') shl 24;
  DMUS_FOURCC_IOSIGNPOST_CHUNK = Ord('s') + Ord('p') shl 8 + Ord('s') shl 16 +
    Ord('h') shl 24;
  DMUS_FOURCC_CHORDNAME_CHUNK = Ord('I') + Ord('N') shl 8 + Ord('A') shl 16 +
    Ord('M') shl 24;

  // runtime list chunks
  DMUS_FOURCC_CHORDENTRY_LIST = Ord('c') + Ord('h') shl 8 + Ord('o') shl 16 +
    Ord('e') shl 24;
  DMUS_FOURCC_CHORDMAP_LIST = Ord('c') + Ord('m') shl 8 + Ord('a') shl 16 +
    Ord('p') shl 24;
  DMUS_FOURCC_CHORD_LIST = Ord('c') + Ord('h') shl 8 + Ord('r') shl 16 + Ord('d')
    shl 24;
  DMUS_FOURCC_CHORDPALETTE_LIST = Ord('c') + Ord('h') shl 8 + Ord('p') shl 16 +
    Ord('l') shl 24;
  DMUS_FOURCC_CADENCE_LIST = Ord('c') + Ord('a') shl 8 + Ord('d') shl 16 +
    Ord('e') shl 24;
  DMUS_FOURCC_SIGNPOSTITEM_LIST = Ord('s') + Ord('p') shl 8 + Ord('s') shl 16 +
    Ord('t') shl 24;

  DMUS_FOURCC_SIGNPOST_LIST = Ord('s') + Ord('p') shl 8 + Ord('s') shl 16 +
    Ord('q') shl 24;
  ...
  DMUS_SIGNPOSTF_E = $10;
  DMUS_SIGNPOSTF_F = $20;
  DMUS_SIGNPOSTF_LETTER = (DMUS_SIGNPOSTF_A or DMUS_SIGNPOSTF_B or
    DMUS_SIGNPOSTF_C or DMUS_SIGNPOSTF_D or DMUS_SIGNPOSTF_E or DMUS_SIGNPOSTF_F);
  ...
  DMUS_SIGNPOSTF_ROOT = (DMUS_SIGNPOSTF_1 or DMUS_SIGNPOSTF_2 or DMUS_SIGNPOSTF_3
    or DMUS_SIGNPOSTF_4 or DMUS_SIGNPOSTF_5 or DMUS_SIGNPOSTF_6 or
    DMUS_SIGNPOSTF_7);
...
const
  // Signpost tracks
  DMUS_FOURCC_SIGNPOST_TRACK_CHUNK = Ord('s') + Ord('g') shl 8 + Ord('n') shl 16
    + Ord('p') shl 24;
...
const
  DMUS_FOURCC_MUTE_CHUNK = Ord('m') + Ord('u') shl 8 + Ord('t') shl 16 + Ord('e')
    shl 24;
...
const
  DMUS_FOURCC_TIME_STAMP_CHUNK = Ord('s') + Ord('t') shl 8 + Ord('m') shl 16 +
    Ord('p') shl 24;

  // Style tracks
  DMUS_FOURCC_STYLE_TRACK_LIST = Ord('s') + Ord('t') shl 8 + Ord('t') shl 16 +
    Ord('r') shl 24;
  DMUS_FOURCC_STYLE_REF_LIST = Ord('s') + Ord('t') shl 8 + Ord('r') shl 16 +
    Ord('f') shl 24;

  // Chord map tracks
  DMUS_FOURCC_PERS_TRACK_LIST = Ord('p') + Ord('f') shl 8 + Ord('t') shl 16 +
    Ord('r') shl 24;
  DMUS_FOURCC_PERS_REF_LIST = Ord('p') + Ord('f') shl 8 + Ord('r') shl 16 +
    Ord('f') shl 24;
  DMUS_FOURCC_TEMPO_TRACK = Ord('t') + Ord('e') shl 8 + Ord('t') shl 16 +
    Ord('r') shl 24;
  DMUS_FOURCC_SEQ_TRACK = Ord('s') + Ord('e') shl 8 + Ord('q') shl 16 + Ord('t')
    shl 24;
  DMUS_FOURCC_SEQ_LIST = Ord('e') + Ord('v') shl 8 + Ord('t') shl 16 + Ord('l')
    shl 24;
  DMUS_FOURCC_CURVE_LIST = Ord('c') + Ord('u') shl 8 + Ord('r') shl 16 + Ord('l')
    shl 24;
  DMUS_FOURCC_SYSEX_TRACK = Ord('s') + Ord('y') shl 8 + Ord('e') shl 16 +
    Ord('x') shl 24;
  DMUS_FOURCC_TIMESIGNATURE_TRACK = Ord('t') + Ord('i') shl 8 + Ord('m') shl 16
    + Ord('s') shl 24;
...
function D3DRGBA(r, g, b, a: TD3DValue): TD3DColor;
begin
  Result := (Trunc(a * 255) shl 24) or (Trunc(r * 255) shl 16) or (Trunc(g * 255)
    shl 8) or
    (Trunc(b * 255));
end;
...
function DirectPlayLobbyCreate; external DPlayXLib name
...
function DirectXDeviceDriverSetup; external DSetupLib name
  'DirectXDeviceDriverSetupA';

function DirectXRegisterApplicationA; external DSetupLib;
function DirectXRegisterApplicationW; external DSetupLib;
function DirectXRegisterApplication; external DSetupLib name
...
function DirectSoundCaptureEnumerate; external DSoundLib name
