...
{$IFDEF ERRORFUNCS}
uses se_DirectInput8, se_DirectInput, se_DirectSound, se_DirectMusic, se_DirectPlay, se_DirectPlay8,
     se_Direct3D, se_Direct3DRM, se_DirectDraw, se_DirectShow, se_DirectXGraphics,
     Dialogs, SysUtils;
