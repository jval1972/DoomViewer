...
function TCustomWaveStream.GetSize: Int64;
begin
  Result := -1;
end;
...
procedure TCustomWaveStream.SetSize(const Value: Int64);
begin
end;
...
function TWaveObjectStream.GetSize: Int64;
begin
  Result := FWave.Size;
end;
...
procedure TWaveObjectStream.SetSize(const Value: Int64);
begin
  FWave.Size := Value;
end;
